...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] auth_public_url = {"/","/chirurgies/**","/doctors/**","/admins/**","/patients/**","/dossierMedical/**","/authenticate","/api/**","/register/**", "/**/public/**", "/**/loginForm/**", "/**/VAADIN/**", "/**/vaadinServlet/**"};
